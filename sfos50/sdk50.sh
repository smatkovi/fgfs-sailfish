...
df -h / | tail -1
docker cp $D ba82fa4d3804:/home/mersdk/sfos50
docker exec -u root ba82fa4d3804 chown -R mersdk /home/mersdk/sfos50
docker exec ba82fa4d3804 bash -lc "
  sdk-assistant tooling list | grep -q SailfishOS-$V || sdk-assistant -y tooling create SailfishOS-$V ~/sfos50/Sailfish_OS-$V-Sailfish_SDK_Tooling-i486.tar.7z
  sdk-assistant target list | grep -q SailfishOS-$V-aarch64 || sdk-assistant -y target create --tooling SailfishOS-$V SailfishOS-$V-aarch64 ~/sfos50/Sailfish_OS-$V-Sailfish_SDK_Target-aarch64.tar.7z
  sdk-assistant list
...
rm -rf $D
docker exec ba82fa4d3804 rm -rf /home/mersdk/sfos50
df -h / | tail -1
echo SDK50-FERTIG
