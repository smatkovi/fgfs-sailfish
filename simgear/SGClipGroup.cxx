...
#ifdef SG_GLES2
      /* GLES2 hat keine Clip-Planes. Betroffen ist allein die
         Begrenzung von Regen und Schnee (SGPrecipitation) - ohne sie
         reicht der Niederschlag weiter, mehr passiert nicht. */
#else
