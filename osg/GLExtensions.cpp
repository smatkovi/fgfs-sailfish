    ...
    contextID(in_contextID)
{
    ...
    /* FlightGear GLES port: ES has no generic compressed internal formats; the
       version test above passes on ES 3.x and would pick GL_COMPRESSED_*_ARB. */
    isTextureCompressionARBSupported = false;
#endif
